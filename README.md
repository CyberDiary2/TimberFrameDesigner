# TimberFrameDesigner
Python application that designs timber frame structures based on user-specified dimensions and snow load requirements.  
Automatically calculates appropriate member sizes (posts, beams, rafters) using engineering standards and generates 3D visualization of the structure.  
